...
class SavedTableViewController: UITableViewController {
    ...
    func countItems() {
         itemsInTable = String(self.tableView.numberOfRows(inSection: 0))
    ...
    @IBAction func infoButtonPressed(_ sender: Any) {
        ...
        let alert = UIAlertController(title: "Info", message: "This section is currently holding \(itemsInTable) articles", preferredStyle: .alert)
    ...
    @IBAction func DeleteAllButtonPressed(_ sender: Any) {
        ...
        let alert = UIAlertController(title: "Delete", message: "Are you sure you want to delete all items?", preferredStyle: .alert)
    ...
    func saveCoreData(){
        ...
        do {
            try context?.save()
            basicAlert(title: "Deleted!", message: "You just deleted your articles from Core Data.")
        }catch {
            print(error)
        }
        loadCoreData()
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if savedItems.count == 0 {
            tableView.setEmptyView(title: "You don't have any saved articles.", message: "Please go to the News Feed Bar to check the articles.")
        }
        else {
            tableView.restore()
        }
